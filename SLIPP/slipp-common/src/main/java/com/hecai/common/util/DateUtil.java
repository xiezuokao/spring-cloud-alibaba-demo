...
public class DateUtil {
    ...
    //时间格式
    public static final String PATTERN_YYYYMMDDHH = "yyyy-MM-dd";
    ...
    public static final String PATTERN_YYYY = "yyyy-MM";

    /***
     * 从yyyy-MM-dd HH:mm:ss格式转成yyyyMMddHH格式
     * @param dateStr
     * @return
     */
    public static String formatStr1(String dateStr,String opattern,String npattern){
    ...
    /***
     * 从yyyy-MM-dd HH:mm格式转成yyyy-MM-dd格式
     * @param date
     * @return
     */
    public static String formatStr2(Date date){
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        return simpleDateFormat.format(date);
    }

    /***
     * 从yyyy-MM-dd HH:mm格式转成yyyyMMdd格式
     * @param date
     * @return
     */
    public static String formatStr3(Date date){
     ...
     * @return
     */
    public static String formatStr4(Date date){
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(PATTERN_YYYY_MM_DDHHMMss);
        return simpleDateFormat.format(date);
    }

    /***
     * 从yyyy-MM-dd HH:mm格式转成yyyy-MM格式
     * @param date
     * @return
     */
    public static String formatStr5(Date date){
     ...
     * @return
     */
    public static Date toDayEndHour(Date date){
        Calendar calendar = Calendar.getInstance();
        date = toDayStartHour(date);
        calendar.setTime(date);
